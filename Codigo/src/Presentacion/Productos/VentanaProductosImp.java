...
public class VentanaProductosImp extends VentanaProducto {
	...
	public void initComponent(){
		...
		JButton queOrdenador = new JButton("<html>Ordenador más vendido</html>");
		...
		queOrdenador.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				panel2.removeAll();
				setTitle("Ordenador más vendido");
		...
		JButton queMonitor = new JButton("<html>Monitor más vendido</html>");
