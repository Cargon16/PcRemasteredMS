...
public class VentanaEmpleadosImp extends VentanaEmpleados {
		...
		combo.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if (e.getSource() == combo) {
					...
					case 3:
						panel2.removeAll();
						setTitle("Añadir empleado tiempo parcial");
						empTP.resetCamps();
	...
	public void actualizar(Contexto contexto) {
		...
		case Eventos.updateEmpeladoCommandError:
			if(Integer.valueOf(contexto.getDatos().toString()) == -2)JOptionPane.showMessageDialog(null, "No se puede cambiar la situación de un empleado.");
