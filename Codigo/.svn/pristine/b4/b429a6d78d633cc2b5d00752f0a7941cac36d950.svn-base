...
public class VentanaVentasImp extends VentanaVentas {
	...
	public void actualizar(Contexto contexto) {
		...
		case Eventos.addProductoVentaCommand:JOptionPane.showMessageDialog(null, "Producto añadido correctamente");anadir.actualizar(contexto);break;
		...
		case Eventos.addProductoVentaCommandError: JOptionPane.showMessageDialog(null, "No es posible añadir el producto");break;
		...
		case Eventos.deleteVentaCommandError:JOptionPane.showMessageDialog(null, "Error al procesar la devolución") ;break;
